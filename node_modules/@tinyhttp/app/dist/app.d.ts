...
import type { TemplateEngineOptions } from '../src/index.js';
...
import type { AppConstructor, AppInterface, AppRenderOptions, AppSettings, TemplateEngine } from '../src/types.js';
/**
...
export declare class App<Req extends Request = Request, Res extends Response = Response> extends Router<App, Req, Res> implements AppInterface<Req, Res> {
    ...
    listen(port?: number, cb?: () => void, host?: string): import("http").Server<typeof import("http").IncomingMessage, typeof import("http").ServerResponse>;
}
